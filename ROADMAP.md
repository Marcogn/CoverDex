...
- **Play Store submission.** Explicitly out of scope for the initial
  Capacitor integration — CI produces a signed APK/AAB as a downloadable
  artifact only. Fastlane/Play Console automation is a separate future
  project once the app is stable enough to warrant store distribution.
